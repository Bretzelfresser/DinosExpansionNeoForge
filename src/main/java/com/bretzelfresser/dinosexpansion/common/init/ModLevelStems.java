...
public class ModLevelStems {
    ...
    public static void bootstrap(BootstrapContext<LevelStem> context) {
        ...
        context.register(DINO_LEVEL_STEM_KEY, new LevelStem(
                ...
                new NoiseBasedChunkGenerator(DinoDimensionBiomeSources.createDinoDimensionBiomeSource(biomes), noiseSettings.getOrThrow(ModNoiseGeneratorSettings.DINO_NOISE_SETTINGS_KEY))
        ));
    }
}
