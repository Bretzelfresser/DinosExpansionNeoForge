...
public record RedwoodTreeConfiguration(
    ...
    public RedwoodTreeConfiguration(IntProvider radius, FloatProvider radiusToHeightFactor, BlockStateProvider woodProvider, BlockStateProvider foliageProvider) {
        this(radius, radiusToHeightFactor, woodProvider, foliageProvider,
             UniformFloat.of(0.35f, 0.5f), ConstantInt.of(2), UniformInt.of(3, 4),
             UniformInt.of(6, 10), UniformInt.of(2, 3), UniformInt.of(3, 5), UniformInt.of(2, 4));
    }
    ...
    public static final Codec<RedwoodTreeConfiguration> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            FloatProvider.CODEC.fieldOf("branchStartHeight").orElse(UniformFloat.of(0.35f, 0.5f)).forGetter(RedwoodTreeConfiguration::branchStartHeight),
            IntProvider.CODEC.fieldOf("branchInterval").orElse(ConstantInt.of(2)).forGetter(RedwoodTreeConfiguration::branchInterval),
            IntProvider.CODEC.fieldOf("branchesPerInterval").orElse(UniformInt.of(3, 4)).forGetter(RedwoodTreeConfiguration::branchesPerInterval),
            IntProvider.CODEC.fieldOf("branchLength").orElse(UniformInt.of(6, 10)).forGetter(RedwoodTreeConfiguration::branchLength),
            IntProvider.CODEC.fieldOf("foliageRadius").orElse(UniformInt.of(2, 3)).forGetter(RedwoodTreeConfiguration::foliageRadius),
            IntProvider.CODEC.fieldOf("rootFlareHeight").orElse(UniformInt.of(3, 5)).forGetter(RedwoodTreeConfiguration::rootFlareHeight),
            IntProvider.CODEC.fieldOf("rootFlareLength").orElse(UniformInt.of(2, 4)).forGetter(RedwoodTreeConfiguration::rootFlareLength)
